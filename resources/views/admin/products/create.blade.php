    ...
    <div class="col-md-8">
        <div class="card card-custom bg-white p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="m-0 fw-bold"><i class="bi bi-plus-circle text-success me-2"></i>Add Vendor-wise Product</h5>
            ...
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="e.g. Ripe Tomatoes" required>
                    </div>

                    <div class="col-md-3 mb-3">
                        <label for="today_price" class="form-label fw-bold">Today's Price (₹)</label>
                        <input type="number" step="0.01" class="form-control" id="today_price" name="today_price" value="{{ old('today_price') }}" placeholder="e.g. 40.00" required>
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="unit" name="unit" value="{{ old('unit', '1kg') }}" placeholder="e.g. 1.5 kg" required>
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-primary-custom w-100">Save Product</button>
            </form>
        </div>
    </div>
</div>
