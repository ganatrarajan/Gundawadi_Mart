    ...
    <div class="col-md-8">
        <div class="card card-custom bg-white p-4">
            ...
            <form action="{{ route('admin.vendors.update', $vendor->id) }}" method="POST" enctype="multipart/form-data">
                ...
                @php
                    $oldOpening = old('opening_time', $vendor->opening_time ?? '06:00 AM');
                    ...
                    $oldClosing = old('closing_time', $vendor->closing_time ?? '08:00 PM');
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <div class="form-check form-switch card p-3 shadow-sm border-0 d-flex flex-row align-items-center gap-3">
                            <input class="form-check-input ms-0 mt-0" type="checkbox" id="is_closed" name="is_closed" value="1" {{ old('is_closed', $vendor->is_closed) ? 'checked' : '' }} style="width: 2.5em; height: 1.25em;">
                            <div>
