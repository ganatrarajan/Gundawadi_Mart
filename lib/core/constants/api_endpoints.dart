class ApiEndpoints {
  ...
  // Base configurations
  static const String baseUrl = 'http://168.144.147.94:8080/api';
  ...
  static String formatImageUrl(String? url) {
    ...
    const String baseHost = 'http://168.144.147.94:8080';
    String formatted = url;
    
    if (formatted.contains('localhost')) {
      formatted = formatted.replaceAll('localhost', '168.144.147.94:8080');
    }
    if (formatted.contains('127.0.0.1')) {
      formatted = formatted.replaceAll('127.0.0.1', '168.144.147.94:8080');
    }
    if (formatted.contains('192.168.1.10:8000')) {
      formatted = formatted.replaceAll('192.168.1.10:8000', '168.144.147.94:8080');
    }
    if (formatted.contains('192.168.1.10')) {
      formatted = formatted.replaceAll('192.168.1.10', '168.144.147.94:8080');
    }
